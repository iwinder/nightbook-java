...
public class DouBanUtilTest {
    ...
    public static Book findBookInfoFromDouBanByISBNTest(String isbn){
        ...
        String s2 = "{\n" +
                ...
                "tags: [],\n" +
                "origin_title: \"\",\n" +
                "image: \"https://img3.doubanio.com/mpic/s6499284.jpg\",\n" +
                "binding: \"平装\",\n" +
                "translator: [ ],\n" +
                "catalog: \"\",\n" +
                "pages: \"200\",\n" +
                "images: {\n" +
                "small: \"https://img3.doubanio.com/spic/s6499284.jpg\",\n" +
                "large: \"https://img3.doubanio.com/lpic/s6499284.jpg\",\n" +
                "medium: \"https://img3.doubanio.com/mpic/s6499284.jpg\"\n" +
                "},\n" +
                "alt: \"https://book.douban.com/subject/1488532/\",\n" +
                "id: \"1488532\",\n" +
                "publisher: \"陕西师范大学出版社\",\n" +
                "isbn10: \"7561334346\",\n" +
                "isbn13: \"9787561334348\",\n" +
                "title: \"佛教常识答问\",\n" +
                "url: \"https://api.douban.com/v2/book/1488532\",\n" +
                "alt_title: \"\",\n" +
                "author_intro: \"\",\n" +
                "summary: \"《佛教常识答问(最新修订插图本)》是学习佛教知识的最通俗读本，了解佛教文化的首选入门书。采用答问的形式，对佛教的源流、佛学的基本内容和学佛态度都作了详细的表述，涉及了佛教方方面面的知识。读完《佛教常识答问(最新修订插图本)》对佛教就会有全面透彻的了解。 《佛教常识答问(最新修订插图本)》国内印行已达数十万册，被译成日文、英文、韩文等多国文字，畅销海内外。是快速了解佛教的最佳入门书。\",\n" +
                "price: \"28.00元\"\n" +
                "}";
        String s1 = "{\n" +
                "rating: {\n" +
                ...
                "],\n" +
                "origin_title: \"\",\n" +
                "image: \"https://img3.doubanio.com/mpic/s6474704.jpg\",\n" +
                "binding: \"平装\",\n" +
                "translator: [ ],\n" +
                "catalog: \"\",\n" +
                "pages: \"537\",\n" +
                "images: {\n" +
                "small: \"https://img3.doubanio.com/spic/s6474704.jpg\",\n" +
                "large: \"https://img3.doubanio.com/lpic/s6474704.jpg\",\n" +
                "medium: \"https://img3.doubanio.com/mpic/s6474704.jpg\"\n" +
                "},\n" +
                "alt: \"https://book.douban.com/subject/1420734/\",\n" +
                "id: \"1420734\",\n" +
                "publisher: \"中华书局\",\n" +
                "isbn10: \"7101045006\",\n" +
                "isbn13: \"9787101045000\",\n" +
                "title: \"飲水詞箋校\",\n" +
                "url: \"https://api.douban.com/v2/book/1420734\",\n" +
                "alt_title: \"\",\n" +
                "author_intro: \"\",\n" +
                "summary: \"《饮水词》是清初词人纳兰性德的词集。纳兰性德，原名成德，後避太子允扔嫌名（保成）改性德，字容若，号楞伽山人。满洲正黄旗人，大学士明珠长子，生长在北京。性德自幼聪慧好学，长而博通经史，尤好填词，并以填词名世。康熙十五年二六七六）成进士，授乾清门三等侍卫，循迁至一等。多次随扈出巡，并曾奉使梭龙，考察沙俄侵边情况。他生於顺治十一年二六五五），卒於康熙二十四年二六八五），年仅三十一岁。 纳兰性德的著述十分丰富，今存《通志堂集》包括赋一卷，诗四卷，词四卷，经解序跋三卷，序、记、书一卷，杂文一卷，《渌水亭杂识》四卷。然而这只是他创作的一部分。另外，他还编刻遇《大易集义粹言》、《词林正略》、《今词初集》、《通志堂经解》等书。 纳兰性德才华艳发，气质上多受汉文化影响。虽曾有积极用世的抱负，却更向往温馨自在、吟咏风雅的生活。侍卫职司单调拘束，远不合他的情志，因而他雄心销尽，失去了『立功』、『立德』的兴趣。上层政治党争倾轧的污浊内幕，更导致他厌畏思退。诗人的禀赋和生活处境的矛盾，使他憔悴忧伤、哀苦无端，於是，便把无尽凄苦倾诉於笔端，凝聚为哀感顽艳的词章。他的词把原属个人的哀怨融扩为带有普遍性的人性抒发，具有了独特的个性和强烈的感染力。三百年来，尤其近百年来，他是拥有读者最多，影响最大的清代词家，他也是中国古代最杰出的词人之一。 纳兰性德早年曾刻《侧帽词》，康熙十七年（一六七八）又委托顾贞观在吴中刊成《饮水词》，此二本刻於性德生前，今皆不见传本，只知《饮水词》收词不多，仅百余篇，想来，《侧帽词》收词亦不会多。 对纳兰性德词的编辑整理是在纳兰性德身後。康熙三十年（一六九一），性听闻友徐乾学、顾贞观、严绳孙、秦松龄诸人为其编刻《通志堂集》，其中词四卷，共三百首。同年，性德好友张纯修在扬州又有《饮水诗词集》之刻，其中词三卷，共三百零三首，排次舆《通志堂集》相同，惟增词四首，减词一首，此二本中词之部分皆为顾贞观手订，可信度最高。\",\n" +
                "series: {\n" +
                "id: \"15\",\n" +
                "title: \"中國古典文學基本叢書\"\n" +
                "},\n" +
        ...
        System.out.println(DouBanUtils.JsonToBookeInfo(j2).toString());

        System.out.println("-------------");
        System.out.println(j1.toString());
        System.out.println(DouBanUtils.JsonToBookeInfo(j1).toString());
